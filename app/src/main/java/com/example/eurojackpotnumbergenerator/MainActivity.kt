...
import com.example.eurojackpotnumbergenerator.components.EuroJackpotNumberGeneratorScreen
        ...
        setContent {
            EuroJackpotNumberGeneratorTheme {
                Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
                    EuroJackpotNumberGeneratorScreen(modifier = Modifier.padding(innerPadding))
                }
            }
        }
    }
